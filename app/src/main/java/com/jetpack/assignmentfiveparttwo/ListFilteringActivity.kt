...
class ListFilteringActivity : ComponentActivity() {
        ...
        setContent {
            ...
            AssignmentFivePartTwoTheme(darkTheme = finalDarkTheme) {
                Surface(
                    ...
                    ListFilteringScreen(onBackClick = { finish() })
                }
            }
        }
    }
...
@Composable
fun ListFilteringScreen(onBackClick: () -> Unit) {
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("List Filtering + Search") },
                navigationIcon = {
        ...
        Column(
            ...
            Text(
                text = "Section 12: List Filtering + Search",
                fontSize = 20.sp,
