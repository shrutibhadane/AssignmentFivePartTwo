...
class DialogsBottomSheetsActivity : ComponentActivity() {
        ...
        setContent {
            ...
            AssignmentFivePartTwoTheme(darkTheme = finalDarkTheme) {
                Surface(
                    ...
                    DialogsBottomSheetsScreen(onBackClick = { finish() })
                }
            }
        }
    }
...
@Composable
fun DialogsBottomSheetsScreen(onBackClick: () -> Unit) {
    Scaffold(
        topBar = {
            TopAppBar(
        ...
        Column(
            ...
            Text(
                text = "Section 10: Dialogs & Bottom Sheets",
                fontSize = 20.sp,
                fontWeight = FontWeight.Bold,
                color = MaterialTheme.colorScheme.primary
            )
            DialogsBottomSheetsSection()
        }
    }
}
