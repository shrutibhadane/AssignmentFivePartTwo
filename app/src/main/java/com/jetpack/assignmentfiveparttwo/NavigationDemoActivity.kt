        ...
        setContent {
            ...
            AssignmentFivePartTwoTheme(darkTheme = finalDarkTheme) {
                Surface(
                    ...
                    NavigationDemoScreen(onBackClick = { finish() })
                }
            }
        }
    }
...
@Composable
fun NavigationDemoScreen(onBackClick: () -> Unit) {
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Navigation with Arguments") },
                navigationIcon = {
        ...
        Column(
            ...
            Text(
                text = "Section 9: Navigation with Arguments",
                fontSize = 20.sp,
