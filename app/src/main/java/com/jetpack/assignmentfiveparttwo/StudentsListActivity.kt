        ...
        setContent {
            ...
            AssignmentFivePartTwoTheme(darkTheme = finalDarkTheme) {
                Surface(
                    ...
                    StudentsListScreen(onBackClick = { finish() })
                }
            }
        }
    }
...
@Composable
fun StudentsListScreen(onBackClick: () -> Unit) {
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(stringResource(R.string.students_list)) },
                navigationIcon = {
        ...
        Column(
            ...
            Text(
                text = stringResource(R.string.section_3_lazycolumn_with_30_students),
                fontSize = 20.sp,
