...
class CustomTextFieldActivity : ComponentActivity() {
        ...
        setContent {
            ...
            AssignmentFivePartTwoTheme(darkTheme = finalDarkTheme) {
                Surface(
                    ...
                    CustomTextFieldScreen(onBackClick = { finish() })
                }
            }
        }
    }
...
@Composable
fun CustomTextFieldScreen(onBackClick: () -> Unit) {
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Custom TextField UI") },
                navigationIcon = {
        ...
        Column(
            ...
            Text(
                text = "Section 7: Custom TextField UI",
                fontSize = 20.sp,
