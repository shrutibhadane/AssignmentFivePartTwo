        ...
        setContent {
            ...
            AssignmentFivePartTwoTheme(darkTheme = finalDarkTheme) {
                Surface(
                    ...
                    SlotsApiScreen(onBackClick = { finish() })
                }
            }
        }
    }
...
@Composable
fun SlotsApiScreen(onBackClick: () -> Unit) {
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(stringResource(R.string.slots_api_demo)) },
                navigationIcon = {
        ...
        Column(
            ...
            Text(
                text = stringResource(R.string.section_2_slots_api_header_footer),
                fontSize = 20.sp,
