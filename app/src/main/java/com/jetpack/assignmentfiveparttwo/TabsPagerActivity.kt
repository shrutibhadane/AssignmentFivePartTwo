...
class TabsPagerActivity : ComponentActivity() {
        ...
        setContent {
            ...
            AssignmentFivePartTwoTheme(darkTheme = finalDarkTheme) {
                Surface(
                    ...
                    TabsPagerScreen(onBackClick = { finish() })
                }
            }
        }
    }
...
@Composable
fun TabsPagerScreen(onBackClick: () -> Unit) {
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Tabs + Pager") },
                navigationIcon = {
