...
class AnimationBasicsActivity : ComponentActivity() {
        ...
        setContent {
            ...
            AssignmentFivePartTwoTheme(darkTheme = finalDarkTheme) {
                Surface(
                    ...
                    AnimationBasicsScreen(onBackClick = { finish() })
                }
            }
        }
    }
...
@Composable
fun AnimationBasicsScreen(onBackClick: () -> Unit) {
    Scaffold(
        topBar = {
            TopAppBar(
        ...
        Column(
            ...
            Text(
                text = "Section 6: Animation Basics",
                fontSize = 20.sp,
                fontWeight = FontWeight.Bold,
                color = MaterialTheme.colorScheme.primary
            )
            AnimationBasicsSection()
        }
    }
}
